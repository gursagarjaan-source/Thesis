...
const LANDING_CSS = `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .brand-text.footer .khet{color:#7CBF6B}
  .brand-text.footer .lab{color:rgba(255,255,255,0.7)}
  ...
  @media(max-width:768px){.desktop-only{display:none!important}.mobile-only{display:flex!important}.brand-text{font-size:26px}.hero-grid{padding:32px 18px!important;gap:40px!important}.hero-right{min-height:380px!important}.sec-wrap{padding:56px 18px!important}.grid-3{grid-template-columns:1fr!important}.grid-tools{grid-template-columns:1fr!important}.grid-2-end{grid-template-columns:1fr!important}.stat-grid-2{grid-template-columns:1fr 1fr!important}.footer-grid{grid-template-columns:1fr!important}.hero-demo{transform:scale(0.85);transform-origin:center}.micro-l1{left:0!important}.micro-l2{left:0!important}.micro-r1{right:0!important}.micro-r2{right:0!important}}
  @media(max-width:520px){.brand-text{font-size:24px}.grid-4{grid-template-columns:1fr!important}.stat-grid-2{grid-template-columns:1fr!important}.hero-demo{transform:scale(0.75)}.micro-l1,.micro-l2,.micro-r1,.micro-r2{display:none!important}}
  @media(max-width:380px){.brand-text{font-size:22px}}
`;
      ...
      <div className="footer-grid" style={{display:'grid',gridTemplateColumns:'2fr 1fr 1fr 1fr 1fr',gap:40,marginBottom:56}}>
        <div>
          <div style={{display:'flex',alignItems:'center',gap:10,marginBottom:16}}>
            <span className="brand-text footer"><span className="khet">Khet</span><span className="lab">Lab</span></span>
          </div>
